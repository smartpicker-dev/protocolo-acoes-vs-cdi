**Protocolo v1.2 — Ações vs CDI (simulação educacional reprodutível)**
...
Regra de mudanças: qualquer alteração após este congelamento vira versão 1.3 e exige justificativa escrita (o que mudou, por quê, impacto esperado).

Changelog:  
v1.2 — Substituição por auditabilidade (pré-coleta): após o v1.1, constatou-se que GGBR3 também não possui histórico mensal completo no Mais Retorno para os recortes exigidos (ex.: janela/corte D-12m de 10/02/2020 a 10/02/2025 indica Qtd.M=288, abaixo dos 301 esperados), reduzindo reprodutibilidade/QA. Substituição: GGBR3 → ALPA3 no Portfólio B, mantendo a regra setorial (economia real: consumo cíclico/industrial). Demais parâmetros (D0/janelas, pesos iguais, buy & hold sem rebalance, benchmarks, métricas e robustez) permanecem inalterados.
...
\- Qualquer mudança depois do congelamento → Protocolo v1.3 com justificativa escrita.
...
As carteiras A/B/C listadas abaixo são a instanciação fixa desta regra para este estudo, congelada na versão 1.2; qualquer alteração de ativos, pesos, número de ações, ou dos blocos setoriais definidos acima exige versão 1.3 com justificativa explícita.
...
\- Não expandir universo além do core (a menos que vire v1.3).  
...
Assinatura do protocolo (v1.2)  
Autor: Patrick Gerard Pin —  Data: 12/02/2026  
Declaração de congelamento: “Qualquer mudança depois disso é versão 1.3 e precisa justificativa.”
