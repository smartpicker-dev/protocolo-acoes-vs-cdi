Protocolo v1.0 — Ações vs CDI (simulação educacional reprodutível)
...
Regra de mudanças: qualquer alteração após este congelamento vira versão 1.1 e exige justificativa escrita (o que mudou, por quê, impacto esperado).
...
- Qualquer mudança depois do congelamento → Protocolo v1.1 com justificativa escrita.
...
- Tickers difíceis de auditar por mudanças complexas (fusões/reorganizações) que prejudiquem a reprodutibilidade.
...
As carteiras A/B/C listadas abaixo são a instanciação fixa desta regra para este estudo, congelada na versão 1.0; qualquer alteração de ativos, pesos, número de ações, ou dos blocos setoriais definidos acima exige versão 1.1 com justificativa explícita.

Carteiras (congeladas):
- Portfólio A: PETR3, VALE3, ITUB3, BBAS3, CMIG3, EGIE3, ABEV3, VIVT3
- Portfólio B: PETR3, VALE3, BBDC3, ITUB3, CPLE3, EGIE3, KLBN3, SBSP3
...
- Não expandir universo além do core (a menos que vire v1.1).
...
Assinatura do protocolo (v1.0)
Autor: Patrick Gerard Pin —  Data: 12/02/2026
Declaração de congelamento: “Qualquer mudança depois disso é versão 1.1 e precisa justificativa.”
